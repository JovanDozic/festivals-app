...
const (
	LocationService_SaveAddress_FullMethodName = "/location.LocationService/SaveAddress"
)
...
func (c *locationServiceClient) SaveAddress(ctx context.Context, in *SaveAddressRequest, opts ...grpc.CallOption) (*SaveAddressResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SaveAddressResponse)
	err := c.cc.Invoke(ctx, LocationService_SaveAddress_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedLocationServiceServer) SaveAddress(context.Context, *SaveAddressRequest) (*SaveAddressResponse, error) {
...
func _LocationService_SaveAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SaveAddressRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LocationServiceServer).SaveAddress(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LocationService_SaveAddress_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LocationServiceServer).SaveAddress(ctx, req.(*SaveAddressRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _LocationService_SaveAddress_Handler,
		},
	},
