...
func Init(c *container.Container) *mux.Router {
	...
	pR.HandleFunc("/festival/organizer/{organizerId}", c.Handlers.Festival.GetByOrganizerId).Methods(http.MethodGet)
	pR.HandleFunc("/festival/organizer/{organizerId}/count", c.Handlers.Festival.GetCountByOrganizerId).Methods(http.MethodGet)
